...
public String obterNomeProduto() {
	return driver.findElement(nomeProduto).getText().toString();
	
}
	

public String obterPrecoProduto() {
	return driver.findElement(precoProduto).getText().toString();
}
...
public List<String> obterOpcoesSelecionada() {
	...
	for(WebElement elemento:elementosSelecionados ) {
		listaOpcoesSelecionadas.add(elemento.getText().toString());
	}
...
public void alterarQuantidade(int quantidadeDoProduto) {
	driver.findElement(quantidadeProduto).clear();
	driver.findElement(quantidadeProduto).sendKeys(Integer.toString(quantidadeDoProduto));
	
}

public ModalProdutoPage clicarbotaoAddToCar() {
